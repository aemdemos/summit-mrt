...
export default function decorate(block) {
  const blockId = getBlockId('card-carousel-rentals');
  ...
  container.classList.add('card-carousel-rentals-slides-container');
  ...
  rows.forEach((row, idx) => {
    ...
    card.classList.add('card-carousel-rentals-slide');
  ...
  if (!isSingleSlide) {
    initSlider(block, {
      slidesContainer: '.card-carousel-rentals-slides',
      slideSelector: '.card-carousel-rentals-slide',
